// pages/Friendchat/Friendchat.js
Page({
 ...
 db.collection('PrivateChat').where({
    Chater: db.command.all([that.data.AnotherOpenid, that.data.MyOpenid])
  }).watch({
